...
public record DetailViewState(
    ...
    public static DetailViewState initial() {
        return new DetailViewState(null, 0, false, null, 0, null, List.of(), 0);
    }

    public DetailViewState withPage(@Nullable ItemPage page) {
        return new DetailViewState(page, scrollOffset, draggingScrollbar, cachedPageId, cachedWidth, cachedLayout, cachedLinks, contentHeight);
    }
    ...
    public DetailViewState withCachedLayout(@Nullable String cachedPageId, int cachedWidth,
                                            @Nullable PreparedDocumentLayout cachedLayout,
                                            List<DocumentRenderer.LinkHit> cachedLinks) {
        return new DetailViewState(page, scrollOffset, draggingScrollbar, cachedPageId, cachedWidth, cachedLayout, cachedLinks, contentHeight);
    }
    ...
    public DetailViewState clearLayoutCache() {
        return new DetailViewState(page, scrollOffset, draggingScrollbar, null, 0, null, List.of(), contentHeight);
    }
