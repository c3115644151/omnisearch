...
public class RenderPipelines {
    ...
    public static final RenderPipeline TRIPWIRE = register(
        RenderPipeline.builder(TERRAIN_SNIPPET)
            .withLocation("pipeline/tripwire")
    ...
    private static RenderPipeline register(RenderPipeline p_404995_) {
        PIPELINES_BY_LOCATION.put(p_404995_.getLocation(), p_404995_);
        return p_404995_;
    }
